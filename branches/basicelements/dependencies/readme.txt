...
--
  ...
  This is a folder where you can extract Sonetto's library dependency packs.

  Any project will look for their libraries in this folder, so you just have
to download the packs from http://code.google.com/p/sonetto/wiki/DependencyPacks
