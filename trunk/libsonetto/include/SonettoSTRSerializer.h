...
// Side note: All this class SONETTO_EXPORT has been coded under the sound track of Goof Troop - Capcom - SNES (1993)
namespace Sonetto
{
    class SONETTO_EXPORT STRData; // Forward declaration
