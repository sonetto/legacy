...
ConfigWindow::ConfigWindow( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	GeneralTab = new wxPanel( SectionTabs, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxNO_BORDER|wxTAB_TRAVERSAL );
	wxBoxSizer* bSizer3;
	bSizer3 = new wxBoxSizer( wxVERTICAL );
	
	GeneralTab->SetSizer( bSizer3 );
	GeneralTab->Layout();
	bSizer3->Fit( GeneralTab );
	SectionTabs->AddPage( GeneralTab, wxT("General"), false );
	...
	m_notebook4 = new wxNotebook( InputTab, ID_PLAYERS_TAB, wxDefaultPosition, wxDefaultSize, 0 );
	m_panel131 = new wxPanel( m_notebook4, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxTAB_TRAVERSAL );
	wxBoxSizer* bSizer91;
	...
	m_panel1311 = new wxPanel( m_notebook4, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxTAB_TRAVERSAL );
	...
	m_panel13111 = new wxPanel( m_notebook4, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxTAB_TRAVERSAL );
	...
	m_panel13112 = new wxPanel( m_notebook4, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxTAB_TRAVERSAL );
